...
import com.yuzhe.ftp.adapter.UploadThreadListAdapter;
...
public class UploadList extends AppCompatActivity {
    public static final int DELETE_OPERATE = 0;
    public static final int UPLOAD_OPERATE = 1;
    private ArrayList<File> files = null;
    private DBHelper dbHelper = null;
    private Handler handler = null;
    private ListView lstView = null;
    private UploadThreadListAdapter adapter = null;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case DELETE_OPERATE:
                        ...
                        Toast.makeText(UploadList.this, "删除成功", Toast.LENGTH_SHORT).show();
                        break;
                    case UPLOAD_OPERATE:
...
//                        dbHelper.update(DBHelper.TBL_NAME_FILE, file.get_id(), FileBrowse.getFileContentValue(file));
        ...
        lstView = (ListView) findViewById(R.id.lstView_upload);
        //从数据库中获取文件数据
        getData();
        adapter = new UploadThreadListAdapter(this, files, dbHelper, handler);
    ...
    private void getData() {
        ...
        Cursor cursor = dbHelper.query(DBHelper.TBL_NAME_FILE, new String[]{"flag"},
                new String[]{FileFlag.Upload_Flag+""});
